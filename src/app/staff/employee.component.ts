...
export class EmployeeComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(private _backendService: BackendService, private employeeService: EmployeeService) { }
  ...
  getData(enrollId, formData?) {
      this.dataLoading = true;
      this.querySubscription = this.employeeService.getStudentsList(enrollId, formData).subscribe((res: any) => {
          console.log(res);
  ...
  setData(formData) {
      ...
      this.querySubscription = this.employeeService.createEmployee(formData, this.attendanceDays, this.feeMonths).then(res => {
          console.log(res);
          if (res) {
  ...
  getDoc(enrollId, docId) {
      ...
      this.dataLoading = true;
      this.data$ = this.employeeService.getDoc(enrollId, docId);
